...
public class Ball implements Comparable<Ball> {
    ...
    private static final String CANT_USE_LOTTO_NUMBER_EXCEPTION_MESSAGE = "사용할 수 있는 로또 번호가 아닙니다.";
    ...
    public static Ball of(int number) {
        ...
        throw new IllegalArgumentException(CANT_USE_LOTTO_NUMBER_EXCEPTION_MESSAGE);
    }
